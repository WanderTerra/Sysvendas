                ...
                if($result->num_rows > 0){
                  while($row = mysqli_fetch_array($result)){
                    ...
                    <tr>
                      ...
                      <td>'.$email.'</td>
                      <td >'.$senha.'</td>
                      <td><a href="excluir2.php?deleteid='.$id.'"<button><i class="bi bi-trash-fill"></i>    </button></a>
                      <a href="AtualizarVendedor.php?updateid='.$id.'"<button><i class="bi bi-pencil-fill"></i></button></a></td>
                  </tr>
                    ';
                  }
                }
